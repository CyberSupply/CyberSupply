...
<div id="main">
	<h1 class="display-1">Criação de projeto</h1>
	<div class="container">
		<form method="post" action="CriaProjeto.do">
			<div class="row">
				<div class="col-md">
					<label class="display-1" id="label">Nome do projeto</label>
					<input class="form-control" placeholder="Insira o nome do projeto" name="nome">
					<label class="display-1" id="label">Linguagem utilizada</label>
					<input class="form-control" placeholder="Insira a linguagem do projeto" name="linguagem">
				</div>
				<div class="col-md">
					<label class="display-1" id="label">Preço do projeto</label>
					<input class="form-control" placeholder=" R$ 0,00" name="preco">
				</div>
			</div>
			<div class="row">
				<div class="col">
				<label class="display-1" id="label">Link do projeto (Github)</label>
				<input class="form-control" placeholder="Insira o link do projeto" name="link">
			...
			<div class="text-center">
				<button class="btn btn-success btn-md" type="submit">Adicionar</button>
